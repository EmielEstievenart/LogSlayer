...
/// Controller-free reload for pull-based views (LogView2): rebuilds the processed
/// model and header from the tracked sources and requests a redraw. The view
/// re-renders from the model itself, so there is no buffer to refresh.
